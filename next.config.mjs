  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: `/docs/base/${LATEST_VERSIONS["base"]}/configuration`,
        permanent: false,
      },
      {
        source: "/docs/base/getting-started",
        destination: `/docs/base/${LATEST_VERSIONS["base"]}/getting-started`,
        permanent: false,
      },
      {
        source: "/docs/base/welcome",
        destination: `/docs/base/${LATEST_VERSIONS["base"]}/welcome`,
        permanent: false,
      },
      {
      ...
      },
      {
        ...
        destination: `/docs/vdp/${LATEST_VERSIONS["vdp"]}/deployment/kubernetes-using-helm`,
        permanent: false,
      },
      {
        source: "/docs/vdp/deployment/overview",
        destination: `/docs/vdp/${LATEST_VERSIONS["vdp"]}/deployment/overview`,
        permanent: false,
      },
      {
        source: "/docs/vdp/development/setup-local-development",
        destination: `/docs/vdp/${LATEST_VERSIONS["vdp"]}/development/setup-local-development`,
        permanent: false,
      },
      {
        source: "/docs/vdp/operators/end",
        destination: `/docs/vdp/${LATEST_VERSIONS["vdp"]}/operators/end`,
        permanent: false,
      },
      {
        source: "/docs/vdp/operators/overview",
        destination: `/docs/vdp/${LATEST_VERSIONS["vdp"]}/operators/overview`,
        permanent: false,
      },
      {
        source: "/docs/vdp/operators/start",
        destination: `/docs/vdp/${LATEST_VERSIONS["vdp"]}/operators/start`,
        permanent: false,
      },
    ];
  },
